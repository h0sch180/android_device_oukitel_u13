...
BOARD_HARDWARE_CLASS += device/OUKITEL/U13/cmhw
...
#BOARD_MKBOOTIMG_ARGS := --kernel_offset $(BOARD_KERNEL_OFFSET) --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --board U13_V0
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset $(BOARD_RAMDISK_OFFSET) --tags_offset $(BOARD_TAGS_OFFSET) --board OUKITEL_U13
...
# Assert
TARGET_OTA_ASSERT_DEVICE := u13,U13,OUKITEL_U13,oukitel_u13
...
# RIL
BOARD_RIL_CLASS := ../../../device/OUKITEL/U13/ril
